...
export default function ColorPalettePage() {
  ...
  const [palette, setPalette] = useState(mockPalette)
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 bg-gray-900 text-white min-h-screen">
      <h1 className="text-3xl font-bold text-center mb-8">Your Outfit's Color Palette</h1>
      ...
      {isAnalyzing ? (
        ...
        <>
          <div className="bg-gray-800 rounded-lg shadow-md p-6 mb-8">
            <h2 className="text-xl font-semibold mb-4 text-white">Color Swatches</h2>
            <div className="flex overflow-x-auto pb-2 gap-2">
              {palette.map((swatch, index) => (
                <div key={index} className="flex-shrink-0">
                  <div className="w-20 h-20 rounded-md shadow-sm" style={{ backgroundColor: swatch.color }}></div>
                  <p className="text-xs text-center mt-1 text-gray-400">{swatch.percentage}%</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg shadow-md p-6 mb-8 text-center">
            <h2 className="text-xl font-semibold mb-2 text-white">Detected Mood</h2>
            ...
            <p className="mt-4 text-gray-300">
              Your outfit colors suggest a {mood.mood.toLowerCase()} mood. We'll create a playlist that matches this
              vibe.
            </p>
          </div>
